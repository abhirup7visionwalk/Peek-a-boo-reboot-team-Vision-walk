# -*- coding: utf-8 -*-
"""
Created on Tue Mar 12 14:35:30 2019

@author: Advait Mishra
"""
...
eyel = cv2.VideoCapture('http://192.168.43.176:8000/eyer.mjpg')
"""
# Argument Video Feeding
eyel = cv2.VideoCapture(argsl["trial3"])
eyer = cv2.VideoCapture(argsl["asdf"])

# Direct video linking
eyel = cv2.VideoCapture("C:/Users/Rahul/Anaconda3/envs/opencv-env/image-classification-keras/trial3.mp4")
eyer = cv2.VideoCapture("C:/Users/Rahul/Anaconda3/envs/opencv-env/image-classification-keras/trial3.mp4")
"""
